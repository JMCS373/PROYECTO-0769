...
#----------------------------------------------------------------------------------------------------------#--------------------------------------------------------------      
    ...
    def CORREOBIENVENIDA(self, ventana):
...
#----------------------------------------------------------------------------------------------------------#--------------------------------------------------------------
    ...
    def ESTUDIANTESNOTES(self, ventana):
        ...
        self.etiqueta2 = tk.Label(ventanaESTCURS, text="INGRESE EL NOMBRE DEL CURSO PARA BUSCAR ESTUDIANTES ")
        self.etiqueta2.grid(column=3, row= 3)
    ...
    def VEREST(self):
        ...
        directorio = "C:/Users/Miguel Choc/Desktop/Proyecto USAC/REGISTROS DE LA ACADEMIA/ESTUDIANTES/"  
        ...
        if palabra != "":
            if archivos_encontrados:
                print("Archivos que contienen la palabra:", palabra)
                for archivo in archivos_encontrados:
                    boton = tk.Button(self.frame, text=archivo, command=lambda a=archivo: self.MOSTRAREST(a))
                    boton.pack()
            else:
                print(f"No se encontraron archivos que contengan la palabra: {palabra}")
        else:
    ...
    def buscar_archivos_con_palabra(self, directorio, palabra_a_buscar):
        archivos_con_palabra = []
